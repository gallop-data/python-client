...
<a name="get_eth_live_listings"></a>
> get_eth_live_listings()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    # example passing only optional values
    body = dict(
        collection_address="0x01cc1bd2dece86e54481f1e6aeffc2fcc6915480",
    )
    try:
        # Collection live listings
        api_response = api_instance.get_eth_live_listings(
            body=body,
        )
    except openapi_client.ApiException as e:
        print("Exception when calling EthereumApi->get_eth_live_listings: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_eth_live_listings.ApiResponseFor200) | OK
400 | [ApiResponseFor400](#get_eth_live_listings.ApiResponseFor400) | Bad request
403 | [ApiResponseFor403](#get_eth_live_listings.ApiResponseFor403) | Unauthorized

#### get_eth_live_listings.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[Unset, ] |  |
...
#### get_eth_live_listings.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_eth_live_listings.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Collection live offers
        api_response = api_instance.get_eth_live_offers(
            body=body,
        )
    except openapi_client.ApiException as e:
        print("Exception when calling EthereumApi->get_eth_live_offers: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_eth_live_offers.ApiResponseFor200) | OK
400 | [ApiResponseFor400](#get_eth_live_offers.ApiResponseFor400) | Bad request
403 | [ApiResponseFor403](#get_eth_live_offers.ApiResponseFor403) | Unauthorized

#### get_eth_live_offers.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[Unset, ] |  |
...
#### get_eth_live_offers.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_eth_live_offers.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
**normalized** | bool,  | BoolClass,  | Return normalized data across marketplaces | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
<a name="get_eth_wallet_valuation"></a>
> get_eth_wallet_valuation()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Value All Tokens Owned by Wallet
        api_response = api_instance.get_eth_wallet_valuation(
            body=body,
        )
    except openapi_client.ApiException as e:
        print("Exception when calling EthereumApi->get_eth_wallet_valuation: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_eth_wallet_valuation.ApiResponseFor200) | An object containing the tokens owned by this wallet
400 | [ApiResponseFor400](#get_eth_wallet_valuation.ApiResponseFor400) | Bad request
403 | [ApiResponseFor403](#get_eth_wallet_valuation.ApiResponseFor403) | Unauthorized

#### get_eth_wallet_valuation.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[Unset, ] |  |
...
#### get_eth_wallet_valuation.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_eth_wallet_valuation.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
